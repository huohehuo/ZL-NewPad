...
public class T_mainDao extends AbstractDao<T_main, String> {
    ...
    public static class Properties {
        ...
        public final static Property CompanyId = new Property(39, String.class, "companyId", false, "COMPANY_ID");
    ...
    public T_main readEntity(Cursor cursor, int offset) {
        T_main entity = new T_main( //
            ...
            cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39), // companyId
    ...
    public void readEntity(Cursor cursor, T_main entity, int offset) {
        ...
        entity.setCompanyId(cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39));
