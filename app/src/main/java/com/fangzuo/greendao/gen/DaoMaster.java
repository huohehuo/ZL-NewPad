...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        BackGoodsBeanDao.createTable(db, ifNotExists);
        BarCodeDao.createTable(db, ifNotExists);
        BibieDao.createTable(db, ifNotExists);
        BibieTableDao.createTable(db, ifNotExists);
        ChangePriceDao.createTable(db, ifNotExists);
        ClassificationDao.createTable(db, ifNotExists);
        ...
        TempChangePriceDao.createTable(db, ifNotExists);
        TempDetailDao.createTable(db, ifNotExists);
        TempMainDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        BackGoodsBeanDao.dropTable(db, ifExists);
        BarCodeDao.dropTable(db, ifExists);
        BibieDao.dropTable(db, ifExists);
        BibieTableDao.dropTable(db, ifExists);
        ChangePriceDao.dropTable(db, ifExists);
        ClassificationDao.dropTable(db, ifExists);
        ...
        TempChangePriceDao.dropTable(db, ifExists);
        TempDetailDao.dropTable(db, ifExists);
        TempMainDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(TempChangePriceDao.class);
        registerDaoClass(TempDetailDao.class);
        registerDaoClass(TempMainDao.class);
