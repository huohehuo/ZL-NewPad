...
public class ShareUtil {
    ...
    public void setShortTreeOutCompany(int val){
        editor.putInt("shortTreeOutCompany",val).apply();
    }

    public int getShortTreeOutCompany(){
        return shared.getInt("shortTreeOutCompany",0);
    }
    ...
    public void setSOUTOrderNo(int i){
        editor.putInt("SOUTOrderNo",i).apply();
    }

    public int getSOUTOrderNo(){
        return shared.getInt("SOUTOrderNo",1);
    }
    ...
    public int getPGGetType(){
        return shared.getInt("getPGGetType",0);
    }
    ...
    public void setSOUTDisEnable(boolean isEnable){
        editor.putBoolean("SOUTDisEnable",isEnable).apply();
    }

    public boolean getSOUTDisEnable(){
        return shared.getBoolean("SOUTDisEnable",true);
    }

    public void setSVanNo(String vanno){
        editor.putString("setSVanNo",vanno).apply();
    }

    public String getSVanNo(){
        return shared.getString("setSVanNo","");
    }

    public void setSVanDriver(String vanno){
        editor.putString("setSVanDriver",vanno).apply();
    }

    public String getSVanDriver(){
        return shared.getString("setSVanDriver","");
    }

    public void setSClient(String vanno){
        editor.putString("setSClient",vanno).apply();
    }

    public String getSClient(){
        return shared.getString("setSClient","");
    }

    public void setSClientID(String vanno){
        editor.putString("setSClientID",vanno).apply();
    }

    public String getSClientID(){
        return shared.getString("setSClientID","0");
    }
    ...
    public void setSOUTLOrderNo(int i){
        editor.putInt("setSOUTLOrderNo",i).apply();
    }

    public int getSOUTLOrderNo(){
        return shared.getInt("setSOUTLOrderNo",1);
    }

    public long getSOUTLOrderCode(){
        return shared.getLong("setSOUTLOrderCode",0);
    }

    public void setSOUTLOrderCode(long PISOrderCode){
        editor.putLong("setSOUTLOrderCode",PISOrderCode).apply();
    }

    public void setSOUTLisEnable(boolean isEnable){
        editor.putBoolean("setSOUTLisEnable",isEnable).apply();
    }

    public boolean getSOUTLisEnable(){
        return shared.getBoolean("setSOUTLisEnable",true);
    }

    public void setLVanNo(String vanno){
        editor.putString("setLVanNo",vanno).apply();
    }

    public String getLVanNo(){
        return shared.getString("setLVanNo","");
    }

    public void setLVanDriver(String vanno){
        editor.putString("setLVanDriver",vanno).apply();
    }

    public String getLVanDriver(){
        return shared.getString("setLVanDriver","");
    }

    public void setLClient(String vanno){
        editor.putString("setLClient",vanno).apply();
    }

    public String getLClient(){
        return shared.getString("setLClient","");
    }

    public void setLClientID(String vanno){
        editor.putString("setLClientID",vanno).apply();
    }

    public String getLClientID(){
        return shared.getString("setLClientID","0");
    }
}
