...
public class SecondRvForLongAdapter extends RecyclerView.Adapter<SecondRvForLongAdapter.ViewHolder> {
    public ArrayList<SecondCheck> items;
    Context context;
    private OnItemClickListener onItemClickListener;

    public SecondRvForLongAdapter(Context context, ArrayList<SecondCheck> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tvLength.setText(items.get(position).length);        //长度
        if ("红字".equals(items.get(position).FRedBlue)){
            ...
            holder.tvLength.setTextColor(Color.RED);
        }
    }
