...
public class ProductCkAdapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    List<T_main> main;
    ...
    public ProductCkAdapter(Context context,List<T_Detail> detail, List<Boolean> isCheck) {
