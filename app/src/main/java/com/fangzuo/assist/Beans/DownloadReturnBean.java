...
public class DownloadReturnBean {
	...
	public ArrayList<FirstCheck> firstChecks;
	public ArrayList<SecondCheck> secondChecks;
	public ArrayList<ThirdCheck> thirdChecks;
	public ArrayList<RegisterBean> registers;
	public ArrayList<StorageCheckA> storageCheckAS;
	public ArrayList<StorageCheckB> storageCheckBS;
	public ArrayList<StorageCheckC> storageCheckCS;
	public ArrayList<ChangePrice> changePrices;
	public ArrayList<AccountCheckData> accountCheckDatas;
