...
public class LongTreeOutLForRedActivity extends BaseActivity implements BillRvAdapter.RvInnerClickListener {
    ...
    DrawerLayout drawer;
    private LongTreeOutLForRedActivity mContext;
    ...
    public void initView() {
        setContentView(R.layout.activity_long_tree_red);
        mContext = this;
        ...
        num = Hawk.get(Config.Long_red_OrderNo_i,1);
        getClassification();
    ...
    public void initData() {
        etVanNo.setText(Hawk.get(Config.Long_red_VanNo_s,""));
        etDriver.setText(Hawk.get(Config.Long_red_Driver_s,""));
        clientId = Hawk.get(Config.Long_red_ClientId_s,"");
        clientName = Hawk.get(Config.Long_red_ClientName_s,"");
        edClient.setText(clientName);

        tvDate.setText(Hawk.get(Config.Long_red_Date_s,getTime(true)));
        tvDatePay.setText(Hawk.get(Config.Long_red_DatePay_s,getTime(true)));

        //用于判断是否存在未完单，锁定指定控件
        boolean isAble=Hawk.get(Config.Long_red_lock_b,true);
...
//        }
    ...
    public void getHuiDanData() {
        ...
        Cursor cursor = daoSession.getDatabase().rawQuery("SELECT " +
                ...
                "FPRODUCT_NAME,FPRODUCT_ID ORDER BY FORDER_ID DESC", new String[]{Config.CHOOSE_SECOND_FRAGMENT_LONG_RED + ""});
        ...
        if (saleMethodSpAdapter!=null){
            for (int j = 0; j < saleMethodSpAdapter.getCount(); j++) {
                if (((PurchaseMethod) saleMethodSpAdapter.getItem(j)).getFName().equals("赊销")) {
                    ...
                    Hawk.put(Config.Long_red_SaleMethodSp_i,j);
                    break;
                }
            }
        }
//        spSaleMethod.setSelection(share.getSOUTsaleMethod());
        ...
        spDepartment.setSelection(  Hawk.get(Config.Long_red_DepartmentSp_i,0)  >departMentAdapter.getCount()?0:Hawk.get(Config.Long_red_DepartmentSp_i,0));
        spCompany.setSelection(     Hawk.get(Config.Long_red_CompanySp_i,0)     >companySpAdapter.getCount()?0:Hawk.get(Config.Long_red_CompanySp_i,0));
        spSaleScope.setSelection(   Hawk.get(Config.Long_red_SaleRangeSp_i,0)   >slaesRange.getCount()?0:Hawk.get(Config.Long_red_SaleRangeSp_i,0));
        spYuandan.setSelection(     Hawk.get(Config.Long_red_YuandanSp_i,0)     >employeeAdapter.getCount()?0:Hawk.get(Config.Long_red_YuandanSp_i,0));
        spPayMethod.setSelection(   Hawk.get(Config.Long_red_PayMethodSp_i,0)   >payTypeSpAdapter.getCount()?0:Hawk.get(Config.Long_red_PayMethodSp_i,0));
        spEmployee.setSelection(    Hawk.get(Config.Long_red_EmployeeSp_i,0)    >employeeAdapter.getCount()?0:Hawk.get(Config.Long_red_EmployeeSp_i,0));
        spManager.setSelection(     Hawk.get(Config.Long_red_ManagerSp_i,0)     >employeeAdapter.getCount()?0:Hawk.get(Config.Long_red_ManagerSp_i,0));
        spSendMethod.setSelection(  Hawk.get(Config.Long_red_SendmethodSp_i,0)  >getGoodsType.getCount()?0:Hawk.get(Config.Long_red_SendmethodSp_i,0));
...
//                    });
    ...
    public void initListener() {
        ...
        isAutoAdd.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                isAuto = b;
                Hawk.put(Config.Long_red_isAutoAdd_b,b);
            }
        });
        ...
        spDepartment.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Hawk.put(Config.Long_red_DepartmentSp_i,i);
            }
        ...
        spSaleMethod.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_SaleMethodSp_i,i);
        ...
        spSaleScope.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_SaleRangeSp_i,i);
...
//                Log.e("dddd222",share.getShortTreeOutCompany()+"");
                ...
                Hawk.put(Config.Long_red_CompanySp_i,i);
...
//                Log.e("dddd333",share.getShortTreeOutCompany()+"");
        ...
        spYuandan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_YuandanSp_i,i);
        ...
        spPayMethod.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_PayMethodSp_i,i);
        ...
        spEmployee.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_EmployeeSp_i,i);
                Employee employee = (Employee) employeeAdapter.getItem(i);
        ...
        spManager.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_ManagerSp_i,i);
                Employee employee = (Employee) employeeAdapter.getItem(i);
        ...
        spSendMethod.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Hawk.put(Config.Long_red_SendmethodSp_i,i);
...
//        return "";
    ...
    protected void onResume() {
        super.onResume();
        if (Hawk.get(Config.has_Change_Bus_Long_Red,false)){
            etVanNo.setText(Hawk.get(Config.Long_red_VanNo_s,""));
            etDriver.setText(Hawk.get(Config.Long_red_Driver_s,""));
            Hawk.put(Config.has_Change_Bus_Long_Red,false);
        }
        if (isBack){
            clientId = Hawk.get(Config.Long_red_ClientId_s,"");
            clientName = Hawk.get(Config.Long_red_ClientName_s,"");
...
//                }).setNegativeButton("取消",null).create().show();
            ...
            case R.id.btn_checkorder:
                ...
                b2.putInt("activity", Config.CHOOSE_SECOND_FRAGMENT_LONG_RED);
    ...
    public void finishOrder() {
        ...
        ab.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                isBack=false;
                Hawk.put(Config.Long_red_VanNo_s,"");
                Hawk.put(Config.Long_red_Driver_s,"");
                Hawk.put(Config.Long_red_ClientId_s,"");
                Hawk.put(Config.Long_red_ClientName_s,"");

                Hawk.put(Config.Long_red_lock_b,true);
                ...
                clientName = "";
                num = 1;
                Hawk.put(Config.Long_red_OrderNo_i,num);
...
//                share.setSOUTLOrderCode(ordercode);
    ...
    public String AddTempOrder(String item) {
        ...
        tempMain.activity = Config.CHOOSE_SECOND_FRAGMENT_LONG_RED;
        ...
        List<TempDetail> list = tempDetailDao.queryBuilder().where(
                ...
                TempDetailDao.Properties.Activity.eq(Config.CHOOSE_SECOND_FRAGMENT_LONG_RED),
        ...
        if (list.size() > 0) {
            ...
            tempDetail.activity = Config.CHOOSE_SECOND_FRAGMENT_LONG_RED;
        ...
        Hawk.put(Config.Long_red_VanNo_s,etVanNo.getText().toString());
        Hawk.put(Config.Long_red_Driver_s,etDriver.getText().toString());
        Hawk.put(Config.Long_red_ClientId_s,clientId);
        Hawk.put(Config.Long_red_ClientName_s,clientName);

        Hawk.put(Config.Long_red_lock_b,false);
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
...
//        searchSupplier.setEnabled(share.getSOUTLisEnable());
    ...
    private void Addorder() {
        ...
        t_mainDao.deleteInTx(t_mainDao.queryBuilder().where(
                        T_mainDao.Properties.Activity.eq(Config.CHOOSE_SECOND_FRAGMENT_LONG_RED),
        ...
        t_main.activity = Config.CHOOSE_SECOND_FRAGMENT_LONG_RED;
        ...
        for (int i = 0; i < tempDetails.size(); i++) {
            ...
            t_detail.activity = Config.CHOOSE_SECOND_FRAGMENT_LONG_RED;
        ...
        for (int i = 0; i < mains.size(); i++) {
            if (i > 0 && mains.get(i).orderId == mains.get(i - 1).orderId) {
                ...
                List<T_Detail> details = t_detailDao.queryBuilder().where(
                        ...
                        T_DetailDao.Properties.Activity.eq(Config.CHOOSE_SECOND_FRAGMENT_LONG_RED)
                ).build().list();
