...
public class ShortTreeOutActivity extends BaseActivity implements BillRvAdapter.RvInnerClickListener {
    ...
    private ShortTreeOutActivity mContext;
    ...
    public void initView() {
        setContentView(R.layout.activity_short_tree);
        mContext = this;
    ...
    public void initData() {
        etVanNo.setText(share.getSVanNo());
        etDriver.setText(share.getSVanDriver());
...
//                share.setSOUTOrderCode(ordercode);
    ...
    public String AddTempOrder(String item) {
        ...
        List<TempDetail> list = tempDetailDao.queryBuilder().where(
                ...
                TempDetailDao.Properties.Activity.eq(Config.CHOOSE_SECOND_FRAGMENT_SHORT),
        ...
        if (list.size() > 0) {
            ...
            tempDetail.activity = Config.CHOOSE_SECOND_FRAGMENT_SHORT;
...
//        }
    ...
    private void Addorder() {
        ...
        for (int i = 0; i < tempDetails.size(); i++) {
            ...
            t_detail.activity = Config.CHOOSE_SECOND_FRAGMENT_SHORT;
